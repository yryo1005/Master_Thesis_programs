...
AE_RESULT_DIR = f"../../results/Autoencoder_2/{USE_UNREAL_IMAGE}_{USE_WORD_IMAGE}_{USE_UNIQUE_NOUN_BOKE}_{MIN_STAR}_{MIN_APPER_WORD}_{MIN_SENTENCE_LENGTH}_{MAX_SENTENCE_LENGTH}_{IMAGE_HEIGHT}_{IMAGE_WIDTH}_{AE_EPOCH}_{AE_BATCH_SIZE}_{AE_LEARNING_RATE}_{AE_FEATURE_DIM}/"

if not os.path.exists("../../results/Autoencoder_2/"):
    os.mkdir("../../results/Autoencoder_2/")
...
RESULT_DIR = f"../../results/GUMI_AE_2/{USE_UNREAL_IMAGE}_{USE_WORD_IMAGE}_{USE_UNIQUE_NOUN_BOKE}_{MIN_STAR}_{MIN_APPER_WORD}_{MIN_SENTENCE_LENGTH}_{MAX_SENTENCE_LENGTH}_{IMAGE_HEIGHT}_{IMAGE_WIDTH}_{AE_EPOCH}_{AE_BATCH_SIZE}_{AE_LEARNING_RATE}_{AE_FEATURE_DIM}_{EPOCH}_{BATCH_SIZE}_{LEARNING_RATE}_{FEATURE_DIM}/"

if not os.path.exists("../../results/GUMI_AE_2/"):
    os.mkdir("../../results/GUMI_AE_2/")
